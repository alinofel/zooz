local function check_member_super(cb_extra, success, result)
  ...
  if success == 0 then
    send_large_msg(receiver, "للادمنـــــية والمـــــدراء فــــ🙂❤️ــقـــط")
  end
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = '🔹 تـــ❗️ـم تفعــــيل المجمــ⛔️ــوعة \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = '🔹تــ❗️ــم تعطــــيل المجمــ⛔️ـــوعة \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local text = "🔹اعـــ🗣ـضاء المجمــ💋ـــوعة🔹"..cb_extra.receiver
local i = 1
for k,v in pairsByKeys(result) do
...
--vardump(result)
local text = "قائــ✔️ــمة ايديـــ🆔ـات الاعضـ🗣ــــاء"..cb_extra.receiver.."\n\n"
local i = 1
for k,v in pairsByKeys(result) do
if not v.print_name then
    name = " "
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    return 'الروابـــ⛔️ــط مقـــ🔒ــفلة بلفــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم قفـــ⏹ـل الروابــ⛔️ــط 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    return 'الروابـــ⛔️ــط مفتـــ🔓ــوحة بلفــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ـم فتــــ⏯ـح الروابـــ⛔️ــط 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function lock_group_spam(msg, data, target)
  ...
  if not is_owner(msg) then
    return "للادمنـــــية والمـــــدراء فــــ🙂❤️ــقـــط"
  end
  local group_spam_lock = data[tostring(target)]['settings']['lock_spam']
  if group_spam_lock == 'yes' then
    return 'الكلايـــ📌ــش مقفـــ🔒ــولة بلفــ✔️ــعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تــــ❗️ـم قفـــ⏹ــل الكلايــ📌ـــش 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    return 'الكلايـــ📌ــش مفتـــ🔓ـوحة بلفــ✔️ـــعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم فتـــ⏯ــح الكلايـــ📌ـش 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    return 'التـــ💉ــكرار مقـــ🔒ــفل بلفــ✔️ــعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم قفــ🔒ـــل التكـــ💉ــرار 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    return 'التــــ💉ـكرار مفتــ🔓ـــوح بلفــ✔️ــعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم فتـــ⏯ــح التكـــ💉ــرار 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    return 'اللـــ🗣ــغة العربــ💯ـــية مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم قفــ⏹ـــل اللـــ🗣ــغة العربــ💯ـــية 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    return 'اللـــ🗣ــغة العربــ💯ـــية مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم فتــ⏯ـــح اللـــ🗣ــغة العربــــ💯ـية 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'yes' then
    return 'الاضــ➕ـــافه مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
  ...
  return 'تـــ❗️ــم قفــ⏹ـــل الاضــ➕ـــافه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    return 'الاضـــ➕ــافه مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
    return 'تـــ❗️ــم فتــ⏯ـــح الاضـــ➕ــافه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    return 'اضــ➕ـــافه الجماعـــ👨‍👩‍👧‍👦ــية مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
    ...
    save_data(_config.moderation.data, data)
  return 'تـــ❗️ــم قفــ⏹ـــل الاضــ➕ـــافه الجماعـــ👨‍👩‍👧‍👦ــية 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    return 'الاضــ➕ـــافه الجماعـــ👨‍👩‍👧‍👦ــية مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
        ...
        if matches[1] == 'قفل' and is_momod(msg) then
            ...
            local msg_type = 'Audio'
                if not is_muted(chat_id, msg_type..': yes') then
                  ...
                  return msg_type..' تـــ❗️ــم قفــ⏹ـــل الصوتيـــ🎵ــات 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الصوتيـــ🎵ــات مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Photo'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم قفــ⏹ـــل الصـ📸ــــور 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الصـ📸ــــور مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Video'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم قفــ⏹ـــل الفيـــ📹ــديو 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الفيـــ📹ــديو مقـــ🔒ــفل بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Gifs'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم قفــ⏹ـــل الصـــ📸ــور المتحـــ🚶ــركه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الصـــ📸ــور المتحـــ🚶ــركه مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Documents'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                  return msg_type..' تـــ❗️ــم قفــ⏹ـــل الفايـــ🗂ــلات 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الفايـــ🗂ــلات مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Text'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم قفــ⏹ـــل الدردشــ💌ـــه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الدردشــ💌ـــه مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'All'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم قفــ⏹ـــل المجمـــ⛔️ــوعه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' المجمـــ⛔️ــوعه مقـــ🔒ــفلة بلفــــ✔️ـعل 😼❗️ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
        ...
        if matches[1] == 'فتح' and is_momod(msg) then
            ...
            local msg_type = 'Audio'
                if is_muted(chat_id, msg_type..': yes') then
                   ...
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح الصوتيـــ🎵ــات 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الصوتيـــ🎵ــات مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Photo'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح الصـ📸ــــور 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الصـ📸ــــور مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Video'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح الفيـــ📹ــديو 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الفيـــ📹ــديو مفـــ🔓ــتوح بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Gifs'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح الصـــ📸ــور المتحـــ🚶ــركه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الصـــ📸ــور المتحـــ🚶ــركه مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Documents'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح الفايـــ🗂ــلات 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الفايـــ🗂ــلات مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'Text'
                if is_muted(chat_id, msg_type..': yes') then
                    ...
                    unmute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح الدردشــ💌ـــه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' الدردشــ💌ـــه مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
            ...
            local msg_type = 'All'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                   return msg_type..' تـــ❗️ــم فتــ⏯ـــح المجمـــ⛔️ــوعه 😽🎈 \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
else
return ""..msg_type..' المجمـــ⛔️ــوعه مفـــ🔓ــتوحة بلفــــ✔️ـعل 😼❕ \n🔹بواسطة :'..msg.from.first_name..'\n' 
   ..'🔸بواسطة :('..msg.from.id..')\n'
   ..'🔹بواسطة :(@'..(msg.from.username or 'لا يوجد')..')\n'
end
            end
