...
VOLUNTARYCHECK=0
I=1
BOT=zo_oz # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m         DEV >   @ali_nofel   < المطور         \e[00;37;40m"
echo ""
cat << EOF
...
echo -e "\033[38;5;208m             DEV : ♕⤵️رآآآفـہہضّي⇣❃                                 \033[0;00m"
echo -e "\033[38;5;208m             DEV :  @ali_nofel                      \033[0;00m"
echo -e "\033[38;5;208m             DEV Bot : @rafidbot                                \033[0;00m"
...
echo -e "\033[38;5;208m       DEV : ♕⤵️رآآآفـہہضّي⇣❃                          \033[0;00m"
echo -e "\033[38;5;208m       DEV :  @ali_nofel                        \033[0;00m"
echo -e "\033[38;5;208m       DEV Bot : @rafidebot                                       \033[0;00m"
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[0m"
echo -e "\033[38;5;208m         IRAQ                                   \033[0;00m"
echo -e "\033[38;5;208m         DEV : ALI NOFEL                       \033[0;00m"
echo -e "\033[38;5;208m         DEV : @ali_nofel                          \033[0;00m"
echo -e "\033[38;5;208m         DEV : @rafidebot        \033[0;00m"
echo -e "\033[38;5;208m         BY♕⤵️رآآآفـہہضّي⇣❃                                 \033[0;00m"	
echo ""
	exit 1
      ;;
	h)
