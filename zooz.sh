...
cat << EOF
 ...
 $f1  @DevPointTeam     $f2 @ali_nofel      $f3  @ali_nofel   $f4  @ali_nofel    $f5 @ali_nofel    $f6 @ali_nofel  $rst

EOF
echo -e "                \e[100m                ali_nofel script           \e[00;37;40m"
echo -e "               \e[01;34m                 By ali_nofel                \e[00;37;40m"
echo ""
cat << EOF
 $bld$f1 @ali_nofel   $f2 @ali_nofel    $f3  @ali_nofel    $f4 @ali_nofel   $f5 @ali_nofel    $f6  @ali_nofel  $rst
...
echo ""
echo -e "\033[38;5;208m     > Channel : @B313K_B                         \033[0;00m"
echo -e "\033[38;5;208m     > Developer : @ali_nofel                        \033[0;00m"
echo -e "\033[38;5;208m     > Bot ID :@Z0_0Z_A                     \033[0;00m"
echo -e "\033[38;5;208m     > Github : GitHub.com/alinofel/zooz         \033[0;00m"
